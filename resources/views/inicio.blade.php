  ...
  <body>
	...
	<div class="container-fluid well">
		...
		<div class="col xs-12 col-sm-6 text-center">
			<a href=""><i class="fa fa-twitter fa-4x social" aria-hidden="true"></i></a>
			...
			<a href=""><i class="fa fa-whatsapp fa-4x social" aria-hidden="true"></i></a> <span class="h3 text-center">3173314579</span>
		</div>
	</div>
	<!-- fin pie de pagina -->
