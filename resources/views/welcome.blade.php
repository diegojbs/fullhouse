...
<!-- Sidenav/menu -->
<nav class="w3-sidenav w3-red w3-collapse w3-top w3-large w3-padding navegacion" style="z-index:3;width:300px;font-weight:bold" id="mySidenav"><br>
  <a href="javascript:void(0)" onclick="w3_close()" class="w3-padding-xlarge w3-hide-large w3-display-topleft w3-hover-white" style="width:100%;font-size:22px">Close Menu</a>
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Full House<br>Prefabricados</b></h3>
  </div>
...
<header class="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
  ...
  <span>Full House Prefabricados</span>
</header>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Casas prefabricadas de alta calidad</b></h1>
